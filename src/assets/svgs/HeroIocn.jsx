...
function SvgComponent(props) {
  return (
    <svg
      ...
      {...props}
    >
      <circle cx={55} cy={55} r={55} fill="url(#prefix__paint0_linear)" />
      <path d="M25 85.2h60v-60H25v60z" fill="url(#prefix__pattern0)" />
      <defs>
        <linearGradient
        ...
        >
          <stop stopColor="#00D77D" />
          <stop offset={1} stopColor="#2DF4A1" />
        </linearGradient>
        <pattern
          id="prefix__pattern0"
